...
namespace Prowl.Editor
{
    ...
    public class ImGuiFileDialog
    {
        ...
        public static List<ImFileDialogInfo> Dialogs = new List<ImFileDialogInfo>();

        public static void UpdateDialogs()
        {
            List<ImFileDialogInfo> finished = new List<ImFileDialogInfo>();
        ...
        public static void FileDialog(ImFileDialogInfo dialogInfo)
        {
            Dialogs.Add(dialogInfo);
        }

        private static bool DrawDialogue(ImFileDialogInfo dialogInfo)
        {
            if (dialogInfo == null)
                return false;
